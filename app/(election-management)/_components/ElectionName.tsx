        ...
        <div className='p-3'>
            ...
            <div>
                <div className='flex justify-around items-center md:w-[50%] mt-7 gap-5 pl-4 pt-4'>
                    ...
                    <Link href="/election-management-dashboard/election-management-candidates" className={`${pathname === '/election-management-dashboard/election-management-candidates' ? 'underline text-[#0654B0]' : 'text-[#B1B2B2]'} text-sm`}>Candidates</Link>
