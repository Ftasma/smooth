...
import { ChevronLeft, CopyIcon, Plus } from 'lucide-react'
...
const Wallet = () => {
    ...
    const getWalletTransactions=async()=>{
        ...
        const query= useQuery({
          ...
          const wallet= query?.data?.data?.data?.wallet
          console.log(wallet);
          useEffect(()=>{
    ...
    <section className=' w-full flex flex-col pt-10 pl-8'>
        ...
        <div className='dashboard-dimensions !w-[95%] md:shadow-md md:px-10 !h-[80vh]'>
            <div className='flex flex-col place-self-start mt-7 gap-3 items-start'>
                ...
                <Dialog>
                    <DialogTrigger>
                        <Button className='bg-[#0654B0] text-white w-[13rem] flex gap-2 text-sm' variant="ghost"><Plus size={20}/>Add cash</Button>
                    </DialogTrigger>
