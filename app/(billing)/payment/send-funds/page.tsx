...
const SendFunds = () => {
  return (
    <section className='h-screen'>
       ...
       <div className='mt-4'>
          <p className='text-lg font-satoshi'>Wallet Balance: <span className='font-satosh'>NGN 8,000.00</span></p>
        </div>
        <div className='mt-2 flex items-center justify-center'>
          <p className='text-3xl font-satoshi text-center'>0983746768368</p>
          <CopyIcon size={24} className='ml-2 cursor-pointer' />
        </div>
        <div className='mt-8'>
          <p className='text-lg font-satoshi'>Account Name: <span className='font-satosh'>PRINCE OGBONNA</span></p>
          <p className='text-lg font-satoshi'>Account Bank: <span className='font-satosh'>Kredi Money MFB LTD</span></p>
          <p className='text-lg font-satoshi'>Amount to Pay: <span className='font-satosh'>NGN 27,000</span></p>
        </div>
